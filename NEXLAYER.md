...
PollWave is a real-time polling and voting platform featuring live results via WebSockets, comprehensive user authentication, and a variety of poll types for public or private engagement.
<!-- nexlayer:end -->
...
|------|------|---------|---------------|
| Next.js | framework | 15.1 | frontend/package.json |
...
- frontend/ — Next.js standalone application for the user interface
- backend/ — Node.js Express server handling API logic and WebSocket connections
...
**Last deployed:** 2026-07-02T15:32:11Z  
...
| Date | Status | Notes |
|------|--------|-------|
| 2026-07-02T15:30:55Z | analyzed | initial repo analysis |
| 2026-07-02T15:32:11Z | success | deployed https://vibrant-wasp-poll-wave.cloud.nexlayer.ai |
<!-- nexlayer:end -->
